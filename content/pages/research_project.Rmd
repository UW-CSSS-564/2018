...
1.  Write your proposal in the document `docs/proposal.Rmd`.
...
The proposal sould consist of a paragraph or two describing.
...
The [Stan Case Studies](http://mc-stan.org/users/documentation/case-studies) provide good exemplars of this style. 
