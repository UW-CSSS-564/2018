...
1.  Research project: The final assignment will ask students to use Bayesian methods to estimate a model to answer a research question of their own.
...
See the [git and GitHub](./pages/git) for links to help introductions and references on git and GitHub.
...
1.  Peer Review. Students should contribute to the intellectual quality of the course by asking and answering questions on our Slack channel.
